...
- Download the tool: [BTW Music Player CSV to JSON](https://github.com/BardRadogost/BTW-Music-Player-CSV-to-JSON)
...
- **Zarządzanie Dużymi Musicpackami (CSV to JSON):**  
  ...
  Zapisz arkusz jako plik `.csv`, a następnie użyj mojego pomocniczego narzędzia, które automatycznie zamieni go na gotowy do użycia plik `songs.json`.
    - **Pobierz narzędzie:** [BTW Music Player CSV to JSON](https://github.com/BardRadogost/BTW-Music-Player-CSV-to-JSON)
